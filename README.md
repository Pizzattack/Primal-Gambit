...
This is **Primal Gambit: Rule of Three**. It's not a perfect replica. It's a fan interpretation — same core rules, same three-lane structure, same elemental triangle (Water beats Fire, Fire beats Nature, Nature beat Water,  Dust loses to everything but has the lowest Risk). But rebuilt from scratch in a single HTML file, with new art generated by AI, a tutorial, statistics, a roguelike mode, and enough content to be its own thing.
